...
# dictionary
classmates_list = [
    Classmate("Cavin Garcia", "Topaz", "Math"),
    Classmate("Alejandro Enriquez", "Topaz", "Math"),
    Classmate("Sean Cotioco", "Topaz", "PE"),
    Classmate("Simrandip Kaur", "Topaz", "PE"),
    Classmate("Ivy Zosa", "Topaz", "TLE")
]
